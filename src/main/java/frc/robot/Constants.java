...
public final class Constants {
    ...
    public static final double FRONT_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(342.06210937500003 + 20 + 180); //  Measure and set front left steer offset
    ...
    public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(204.52031250000002 + 20 + 180); //  Measure and set front right steer offset
    ...
    public static final double BACK_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(331.52109375000003 + 20 + 180); //  Measure and set back left steer offset
    ...
    public static final double BACK_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(86.042578125 + 20 + 180); //  Measure and set back right steer offset
} 
